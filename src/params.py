...
SEG_TARGETS = ['pixel_count_liver', 'pixel_count_spleen', 'pixel_count_kidney', 'pixel_count_bowel']

IMG_TARGETS_EXTENDED = ["bowel_injury", "extravasation_injury", "kidney_injury", "liver_injury", "spleen_injury"]
